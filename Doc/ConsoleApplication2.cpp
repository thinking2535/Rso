...
#define DEFAULT_PORT       "30001"       // Arbitrary, albiet a historical test port
...
void LinkNotify(const CKey& Key_, const CIPPort& IPPort_)
{
    printf("Link %d %u\n", Key_.PeerNum, IPPort_.IP);
...
int main(int argc, char** argv)
{
    ...
    //    CIPPort("0.0.0.0", 30001), SOMAXCONN));
    ...
    for (i = 0, AI = AddrInfo; AI != NULL; AI = AI->ai_next) {
        ...
        cout << "Family : " << AI->ai_family << "-------------------------" << endl;
        if ((AI->ai_family == PF_INET6))
        {

            bool rr = IN6_IS_ADDR_LINKLOCAL((IN6_ADDR*)INETADDR_ADDRESS(AI->ai_addr));
            cout << "IN6_IS_ADDR_LINKLOCAL : " << rr << endl;

            auto ii = ((SOCKADDR_IN6*)(AI->ai_addr))->sin6_scope_id;
            cout << "sin6_scope_id : " << ii << endl;
